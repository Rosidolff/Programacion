...
import ada12_37.Jugador.Posicion;
...
//        altaJugador(equipo, 8);
    ...
    static void mostrar(Map<Integer, Jugador> plantilla, String posicion) {
       ...
       Set<Map.Entry<Integer, Jugador>> equipo = plantilla.entrySet();
        for (Map.Entry<Integer, Jugador> jug : equipo){
            if(jug.getValue().getPosicion().equals(pos) )
